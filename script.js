const projects = [
  {
    ...
    year: '2026',
    type: 'Atto performativo',
    hero: 'images/perdita_hero.webp',
    homePreview: 'images/perdita_hero.webp',
    description: `In un sistema manuale scandito dal tempo analogico, l'atto rielabora attraverso la distruzione e ricomposizione della carta una sfida tra umano e macchina, al quale non c'è nessuna risposta a parte il risultato finale.
...
Progetto a cura del Prof. Marcello Signorile`,
    gallery: [
      'images/perdita_1.webp',
      'images/perdita_2.webp',
      'images/perdita_3.webp',
      'images/perdita_4.webp'
    ],
    videos: [
      'https://player.vimeo.com/video/1199077606?badge=0&autopause=0&player_id=0&app_id=58479'
    ]
  },
  {
    id: 'progetto-1',
...
Progetto a cura del Prof. Marcello Signorile`,
  ...
  },
  {
    ...
    description: `Ricordati di me è un progetto editoriale basato sulle mani presenti nelle opere dal 1200 al 2000.
...
Progetto a cura del Prof. Marcello Signorile`,
  ...
  },
  {
    ...
    year: '2025',
    type: 'Unity',
    hero: 'images/io_sogno_1.webp',
    description: `Il gioco è un’esperienza interattiva basata sulle scelte del giocatore, in cui ogni decisione conduce a una scena diversa. Il progetto è stato sviluppato per una mia compagna di corso. Mi sono occupato della progettazione e programmazione dell’intero gioco, integrando video e animazioni realizzate da Giulia Peli.
`,
    gallery: [
      'images/io_sogno_2.webp',
      'images/io_sogno_3.webp',
      'images/io_sogno_4.webp',
      'images/io_sogno_5.webp',
      'images/io_sogno_6.webp'
    ],
    videos: []
  },
  {
    ...
    description: `Il gioco è stato realizzato durante il corso di Computer Games come esercitazione finalizzata alla progettazione e allo sviluppo di un livello caratterizzato da un percorso da completare. Il progetto prende ispirazione da Marble Blast e dai videogiochi sviluppati con Flash Player nei primi anni 2000, riprendendone alcune meccaniche e l'estetica tipica dell'epoca. All'interno del gioco sono state implementate diverse funzionalità, tra cui la raccolta di stelle come elementi collezionabili, un timer per il monitoraggio della durata della partita, un contatore dei cactus colpiti dal giocatore e un sistema di reset automatico che riporta la rotolacampo all'interno dell'area di gioco quando esce dai limiti previsti (out of bounds).`,
    gallery: [
      'images/TS(2).webp',
      'images/TS(3).webp',
      'images/TS(4).webp',
  ...
  },
  {
    ...
    description: `Il gioco è stato creato durante il corso di Computer Games per comprendere le basi del movimento sul programma Unity, l'aspetto è ispirato ai videogiochi arcade anni '80/90.`,
    gallery: [
  ...
  },
  {
    ...
    description: `EVERYTHING’S FINE EXPECT US è un LED-font progettato da zero insieme alla mia compagna di corso Rebecca Paparella durante l’anno accademico 2024–2025, come progetto finale del corso di Lettering.

Oltre alla progettazione del carattere tipografico, è stata realizzata e stampata una bandiera, successivamente fotografata al Caffè del Teatro in Corso Giuseppe Garibaldi 88 a Urbino.

Il progetto è stato presentato durante la mostra finale del corso “Words – Parole al Vento”, svoltasi il 20 giugno 2025 presso Palazzo Odasi a Urbino, sede della Scuola di Nuove Tecnologie dell’Arte.

Il progetto è stato curato dal professore Francesco Delrosso.
`,
    gallery: [
  ...
  },
  {
    ...
    description: `I poster analizzano le misure in punti delle aste verticali, orizzontali e oblique del font Bank Gothic Regular.

Accademia di Belle Arti di Urbino
Scuola di Nuove Tecnologie dell’Arte
Lettering / 2024–2025
Progetto a cura del Prof. Delrosso
`,
    gallery: [
      'images/info(2).webp',
      'images/info(3).webp',
  ...
  },
  {
    ...
    description: `Io sono l'energia passata presente e futura l'energia che mi è stata donata e che donerà in essa non esiste separazione tra essere e divenire ogni identità viene trascesa in uno spazio libero negato dal niente per affermare il tutto

nella natura che mi ha accolto. nella vibrazione originaria nella pulsazione vitale che ogni vita sostiene lo sono l'energia passata presente e futura l'energia che si è fatta umana una docile fibra dell'universo

Musica utilizzata: Insetti di malincuore

Creato con le mie compagne di corso Francesca De Padova e Benedetta Menna
...
`,
  ...
  },
  {
    ...
    description: `Habitat naturale è un tour virtuale all’interno della mia vita attraverso le mie due case: la mia casa di Urbino, il collegio Tridente, e la mia casa natale di Barletta.

I render 3D sono stati realizzati con il programma MySweetHome e pubblicati sul sito Lapentor. Il progetto è stato sviluppato come lavoro finale per il corso di Progettazione Multimediale I.

Accademia di Belle Arti di Urbino
Scuola di Nuove Tecnologie dell’Arte
Progettazione Multimediale I / 2024–2025
Progetto a cura del Prof. Marcello Signorile
`,
    gallery: [
  ...
  },
  {
    ...
    description: `Habitat naturale è un progetto editoriale concepito come un libro da colorare per bambini, realizzato per il corso di Progettazione Multimediale I.
`,
    gallery: [],
    videos: [],
...
function getVimeoId(url) {
  const match = url.match(/(?:www\.)?vimeo\.com\/(?:video\/)?(\d+)/);
...
function renderProject() {
  ...
  if (project.pdfViewer) {
    ...
    // Imposta navigazione progetti anche per progetti PDF
  ...
  const filteredPhotoMedia = project.id === 'progetto-4' || project.id === 'progetto-14' ? photoMedia.slice(1) : photoMedia;
  ...
  requestAnimationFrame(() => {
    ...
    // Combina tutti i media per il lightbox (escludi duplicati per progetto-4 e progetto-14)
    const filteredGallery = project.id === 'progetto-4' || project.id === 'progetto-14' ? photoMedia.slice(1) : photoMedia;
...
function initLightbox(media) {
  ...
  const prevBtns = document.querySelectorAll('.lightbox-prev');
  const nextBtns = document.querySelectorAll('.lightbox-next');
  ...
  // Event listeners per i pulsanti di navigazione (sia laterali che mobili)
  ...
  function showLightbox() {
    ...
    if (isVimeo) {
      ...
      iframeEl.src = `https://player.vimeo.com/video/${getVimeoId(currentMedia)}`;
  ...
  function closeLightbox() {
    ...
    // Clear media content when closing
    const mediaContainer = document.querySelector('.lightbox-media');
    if (mediaContainer) {
      mediaContainer.innerHTML = '';
    }
